...
function go()
{
document.udate.action='udate.php?view=yes';
...
function exc()
{
document.udate.action='excludate.php';
document.udate.method='post';
document.udate.submit();
}
</script>
...
$_SESSION['ufrom']=$from;
$_SESSION['uto']=$to;
 $c="select rdate, uid, uname, umblno, uemail  from user WHERE rdate BETWEEN '$from' AND '$to'";
 $d=$link->query($c);


echo "<tr><th>Joined Date</th><th>User ID</th><th> Name</th><th> Contact Number </th><th>Email ID </th></tr>";
