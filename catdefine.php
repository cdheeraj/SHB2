...
<table><tr><th>Available Categories</th></tr>
<?php 
...
{
echo "<tr><td>$abc[0]</td></tr>";
}



?></table>
<div class='ab'>Enter New Category: <input type='text' name='cat' id 'cat'></div>
<script>
function save()
{document.c.action='catsave.php';
